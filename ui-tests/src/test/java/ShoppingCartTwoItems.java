...
public class ShoppingCartTwoItems {
  ...
  @Test
  public void testShoppingCartTwoItems() throws Exception {
    ...
    try {
      assertEquals("$15.99", driver.findElement(By.xpath("//div[@id='cart_contents_container']/div/div/div[4]/div[2]/div[2]/div")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
  }
